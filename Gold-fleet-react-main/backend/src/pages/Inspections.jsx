            ...
            <tbody className="divide-y divide-gray-200">
              {inspections.map((inspection) => (
                <tr key={inspection.id} className="hover:bg-gray-50">
                  <td className="px-6 py-5 text-base text-gray-900">{inspection.vehicle?.license_plate || '-'}</td>
                  <td className="px-6 py-5 text-base text-gray-800">{inspection.inspection_date || '-'}</td>
