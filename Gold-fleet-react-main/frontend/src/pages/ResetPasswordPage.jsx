...
const ResetPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.values.password !== form.values.password_confirmation) {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-50 to-gray-100 py-32 px-4 flex flex-col items-center justify-start min-h-screen">
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg flex items-start">
              ...
              <div>
                ...
                <p className="text-sm mt-1">You can now log in with your new password. Redirecting to login...</p>
              </div>
            </div>
          )}
